				   ...
				   -->
                        ...
                        <label id="lblGlobalplay_element_ids" class="label" style="font-size: 100%; color: black;">0</label>
                            ...
                            <div class="row" style="display: inline">
                                ...
                                <div id="playerContainer" class="playerContainer col-md-2">
                                    <!-- img-rounded -->
                                    <div id="controlContainer">
                                        <ul class="controls">
                                            ...
                                            <li>
                                                <a href="#divGlobalplay_screen" id="globalplay_play" class="play" data-attr="playPauseAudio" onclick="return globalplay_init()"></a>
                                                <!-- Play/Pause button -->
                                            ...
                                            <li>
                                                <a href="#divGlobalplay_screen" id="globalplay_stop" class="" data-attr="nextAudio" onclick="return globalplay_stop()">
                                                    <!-- Stop button -->
