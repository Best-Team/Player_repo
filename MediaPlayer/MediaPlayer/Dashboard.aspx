                        ...
                        <div id="divUpload" class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" style="margin-top: 10px;">
                                    <button id="btnConfirmUploadElement" type="button" class="btn btn-default" title="Subir" runat="server" 
                                        onclick="prepareFileUpload_a();" onserverclick="btnConfirmUploadElement_ServerClick">
                                        <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="row" style="display: inline">
                        ...
                        <div id="playerContainer" class="col-md-2 img-rounded" style="height: 140px; width: 55px; margin-top: 10px; background-color: #446e9b; background-image: linear-gradient(to bottom, rgba(255,255,255,0.125) 5%, rgba(255,255,255,0.125) 45%, rgba(255,255,255,0.15) 50%, rgba(0,0,0,0.1) 51%, rgba(0,0,0,0.1) 95%);">
                            <div id="controlContainer">
                                <ul class="controls">
                                    <!-- Controls mask Source: http://www.jqueryrain.com/?vXjX8BEk -->
                                    <li>
                                        <a href="#" class="mute" data-attr="mute"></a>
                                    </li>
                                    <li>
                                        <a href="#" id="globalplay_play" class="play" data-attr="playPauseAudio" onclick="return initGlobalplay()"></a>
                                        <!-- pauseAudio -->
                        ...
                        <div id="divTimelineProgress" style="height: 8px; position: absolute; margin-top: -5px;"></div>
                        <!-- Contenedor draggable para el Progress Pointer -->
